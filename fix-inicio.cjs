...
async function run() {
  const { error } = await s.from('matriculas').update({ data_inicio: '2026-07-01' }).neq('id', '00000000-0000-0000-0000-000000000000');
  console.log(error ? error.message : 'OK - Data de início alterada para 01/07/2026');
}
run();
